...
import{_ as d}from"./preload-helper.BlTxHScW.js";import{t as a,g as f}from"./i18n.Lr-IErb8.js";import{a as u}from"./runtime-dom.esm-bundler.CFA9ZbRW.js";import"./runtime-core.esm-bundler.Bxi63x_M.js";async function _(e,c){const r=document.getElementById("like-button-mount");if(r){const{default:n}=await d(async()=>{const{default:t}=await import("./LikeButton.SmRETTjD.js");return{default:t}},__vite__mapDeps([0,1,2]));u(n,{articleId:e,initialCount:c}).mount(r)}const o=document.getElementById("comment-section-mount");if(o){const{default:n}=await d(async()=>{const{default:t}=await import("./CommentSection.CEcOtaxA.js");return{default:t}},__vite__mapDeps([3,4,2,5,1]));u(n,{articleId:e}).mount(o)}}async function p(){const e=document.getElementById("article-detail");if(!e)return;const c=e.dataset.slug;if(!c)return;const o=f()==="zh"?"zh-CN":"en-US";try{const i=await(await fetch(`/api/v1/articles/${c}`)).json();if(i.code===0&&i.data){const t=i.data;document.title=`${t.title} | Blog`;const m=document.querySelector('meta[name="description"]');m&&m.setAttribute("content",t.summary||t.title);let l=t.content_html||"";if(!l&&t.content){const{renderMarkdown:s}=await d(async()=>{const{renderMarkdown:v}=await import("./markdown.CdwltysG.js");return{renderMarkdown:v}},__vite__mapDeps([6,7,8,5]));l=s(t.content)}e.innerHTML=`
